...
```{r}
geoCode("Johns Hopking University")
```
...
```{r}
results <- close_places("Johns Hopking University", 1000, "school")
...
coord <- data.frame(lon=as.numeric(geoCode("Johns Hopking University")[2]),
           lat=as.numeric(geoCode("Johns Hopking University")[1]))
...
The scripts are only in a simplified version here. The whole code canbe found in my GitHub repository :
